...
define("components/root-component", ["require", "exports"], function (require, exports) {
    "use strict";
...
define("components/project-input", ["require", "exports", "components/root-component", "util/validation", "decorators/autobind", "state/state"], function (require, exports, root_component_js_1, validation_js_1, autobind_js_1, state_js_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    // ------------ //
    //   SUBCLASS   //
    // ------------ //
    class ProjectInput extends root_component_js_1.Component {
        constructor() {
        ...
        submitHandler(e) {
            ...
            if (Array.isArray(userInput)) {
                ...
                state_js_1.projectState.addProject(title, desc, people);
        ...
        gatherUserInputMethod() {
            ...
            if (!validation_js_1.validate(titleValidateable) ||
                !validation_js_1.validate(descriptionValidateable) ||
                !validation_js_1.validate(peopleValidateable)) {
...
define("components/project-item", ["require", "exports", "components/root-component", "decorators/autobind"], function (require, exports, root_component_js_2, autobind_js_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ProjectItem extends root_component_js_2.Component {
...
define("components/project-list", ["require", "exports", "components/root-component", "components/project-item", "models/project", "state/state", "decorators/autobind"], function (require, exports, root_component_js_3, project_item_js_1, project_js_2, state_js_2, autobind_js_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ProjectList extends root_component_js_3.Component {
        constructor(type) {
        ...
        dropHandler(event) {
            ...
            state_js_2.projectState.moveProject(prjId, this.type === "active" ? project_js_2.ProjectStatus.Active : project_js_2.ProjectStatus.Finsihed);
        }
        dragLeaveHandler(_) {
            const listEl = this.element.querySelector("ul");
        ...
        configure() {
            ...
            state_js_2.projectState.addListener((projects) => {
                const relevantProjects = projects.filter((prj) => {
                    if (this.type === "active") {
                        return prj.status === project_js_2.ProjectStatus.Active;
                    }
                    return prj.status === project_js_2.ProjectStatus.Finsihed;
                });
